...
class ZipakuAdapter(private val zipakuCard: ArrayList<ModelDzikir>) :
    RecyclerView.Adapter<ZipakuAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val dzikir = zipakuCard[position]
