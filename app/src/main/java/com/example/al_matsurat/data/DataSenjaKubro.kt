...
object DataSenjaKubro {
    private val txtTitleSenjaKubro = arrayOf(
        //Demo Title
        "Ta'awudz",
        "QS. Al-Fatihah",
        "QS.Al-Baqarah : 1 - 5",
    ...
    private val txtArabicSenjaKubro = arrayOf(
        //Demo Ayat
    ...
    private val txtLatinSenjaKubro = arrayOf(
        //Demo Latin
    ...
    private val txtDescSenjaKubro = arrayOf(
        //Demo Terjemahan
    ...
    val listData: ArrayList<ModelDzikir>
        get() {
            ...
            for (position in txtTitleSenjaKubro.indices) {
                val dzikir = ModelDzikir()
                dzikir.title = txtTitleSenjaKubro[position]
                dzikir.arabic = txtArabicSenjaKubro[position]
                dzikir.latin = txtLatinSenjaKubro[position]
                dzikir.desc = txtDescSenjaKubro[position]
                list.add(dzikir)
            }
            return list
        }
